...
export default function confirm() {
    ...
    return (<>
        <section className="bg-gradient-to-t from-[#17100ae0] to-[rgba(81,47,31,0.67)] max-w-screen-2xl mx-auto h-screen  flex justify-center pt-16 text-xl text-white from-10%  rounded-2xl">
            <form className="border border-primary flex flex-col gap-5 p-5 h-2/3 rounded-2xl">
